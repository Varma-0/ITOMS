...
export class SubProfileDialogComponent {
  hierarchyLevelsList= [];
    hierarchyLevels = [];
      title="";
    startLength;
    ...
    hlId: any;
      ...
      constructor(public dialogRef: MatDialogRef<SubProfileDialogComponent>,private dataService: TerminalService,@Inject(MAT_DIALOG_DATA) public data: any){
