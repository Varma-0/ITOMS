...
@Component({
  selector: 'app-basic-line-chart1',
  templateUrl: './basic-line-chart1.component.html',
  styleUrl: './basic-line-chart1.component.scss'
})
export class BasicLineChart1Component {
  ...
  private renderChart() {
    ...
    if (this.chart) {
      ...
      this.chart = new ApexCharts(document.querySelector("#apex-basic-line-chart1"), options);
      this.chart.render();
    }
  }
