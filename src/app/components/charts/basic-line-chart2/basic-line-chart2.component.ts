...
@Component({
  selector: 'app-basic-line-chart2',
  templateUrl: './basic-line-chart2.component.html',
  styleUrl: './basic-line-chart2.component.scss'
})
export class BasicLineChart2Component {
  @Input() data: any[] = [];
  ...
  private renderChart() {
    ...
    if (this.chart) {
      ...
      this.chart = new ApexCharts(document.querySelector("#apex-basic-line-chart2"), options);
      this.chart.render();
    }
  }
